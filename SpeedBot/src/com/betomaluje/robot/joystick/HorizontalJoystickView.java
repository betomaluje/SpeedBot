...
import com.betomaluje.robot.R;

public class HorizontalJoystickView extends View {
	...
	private int square_dimension = 50;
	...
	public HorizontalJoystickView(Context context, AttributeSet attrs, int defStyle) {
	...
	protected void onLayout(boolean changed, int left, int top, int right,
		...
		int light_red = getResources().getColor(R.color.dark_red);
		int red = getResources().getColor(R.color.red);
		Shader s = new LinearGradient(0, 0, square_dimension * 2,
				square_dimension * 2, light_red, red, Shader.TileMode.CLAMP);
		handlePaint.setShader(s);
	...
	protected void onDraw(Canvas canvas) {		
		...
		handlePaint.setAntiAlias(false);
		handlePaint.setColor(Color.RED);
		canvas.drawRect(handleX - square_dimension, handleY - square_dimension,
				handleX + square_dimension, handleY + square_dimension,
				handlePaint);
